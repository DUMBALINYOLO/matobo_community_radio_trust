        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card style={{backgroundColor: '#0B5345'}} className="mb-4" data-aos="flip-left" >
              ...
              <CardContent className="p-3">
                <h2 style={{color: 'gold'}} className="card-title font-weight-bold font-size-lg" data-aos="flip-up" >
                  FREE MEMBERSHIP
                </h2>
                <p className="card-text" style={{color: 'gold'}} data-aos="flip-up">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card style={{backgroundColor: '#0B5345'}} className="mb-4" data-aos="flip-left" >
              <img alt="..." className="card-img-top" src={mcrt} />
              <CardContent className="p-3">
                <h5 style={{color: 'gold'}} data-aos="flip-up" className="card-title font-weight-bold font-size-lg">
          ...
          <Grid item xs={12} md={4}>
            <Card style={{backgroundColor: '#0B5345'}} className="mb-4"data-aos="flip-left" >
              <img alt="..." className="card-img-top" src={mcrt} />
              <CardContent className="p-3">
                <h5 data-aos="flip-up" style={{color: 'gold'}} className="card-title font-weight-bold font-size-lg">
